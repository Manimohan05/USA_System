  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setUploadProgress({
        ...
        completed: false,
        error: isTimeout
          ? 'Import is taking longer than expected. The server may still be processing and students might already be imported. Please check Student Details and retry only if needed.'
